 ...
 */
class IRERPmodulesbaseresourcesmodelsCompanyProxy extends \IRERP\modules\baseresources\models\Company implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::getCharacterTitle();
    }
    ...
    {
        return array('__isInitialized__', 'CharacterTitle', 'Name', 'Description', 'Pic', 'CharacterType', 'PostalAddresses', 'Emails', 'Telephones', 'BirthDate', 'Nationality', 'id', 'version', 'dateCreated', 'dateLastModified', 'IsDeleted', 'creatorUserId', 'modifierUserId', 'CommericalCode', 'ParentCompany', 'ChildrenCompany');
    }
