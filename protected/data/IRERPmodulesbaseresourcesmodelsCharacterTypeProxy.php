 ...
 */
class IRERPmodulesbaseresourcesmodelsCharacterTypeProxy extends \IRERP\modules\baseresources\models\CharacterType implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'Title', 'Description', 'id', 'version', 'dateCreated', 'dateLastModified', 'IsDeleted', 'creatorUserId', 'modifierUserId');
    }
